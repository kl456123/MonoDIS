...
class RPNModel(Model):
    def init_param(self, model_config):
        ...
        self.bbox_sampler = DetectionSampler({'fg_fraction': 1})
    ...
    def loss(self, prediction_dict, feed_dict):
        ...
        reg_batch_sampled_mask = self.bbox_sampler.subsample_batch(
        ...
        iou_batch_sampled_mask = self.iou_sampler.subsample_batch(
            self.rpn_batch_size, pos_indicator, criterion=rpn_cls_loss)
