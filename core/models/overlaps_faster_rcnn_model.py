...
from core.models.overlaps_rpn_model import OverlapsRPNModel
...
class OverlapsFasterRCNN(Model):
    def forward(self, feed_dict):
        ...
        # difference amplify
        # rcnn_no_bbox_feat = pooled_feat * saliency_map[:, :1, :, :]
        # rcnn_bbox_feat -= rcnn_no_bbox_feat
        rcnn_bbox_feat = rcnn_bbox_feat.mean(3).mean(2)
        # rcnn_bbox_feat = rcnn_bbox_feat.view(rcnn_bbox_feat.shape[0], -1)
    ...
    def init_modules(self):
        ...
        self.rpn_model = OverlapsRPNModel(self.rpn_config)
