...
class BBoxCoder(object):
    ...
    # def encode(self, bboxes, assigned_gt_boxes):
    # reg_targets = self._encode(bboxes, assigned_gt_boxes)

    # if self.bbox_normalize_targets_precomputed:
    # # Optionally normalize targets by a precomputed mean and stdev
    # targets = (reg_targets - self.bbox_normalize_means
    ...
    def _encode(self, ex_rois, gt_rois):
